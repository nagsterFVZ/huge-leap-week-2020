...
import GithubIcon from 'svg-react-loader?name=Icon!../Assets/Icons/logo-github.svg';
...
export default class Footer extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      menuItems: [
        {value: 'home', name: 'Home', route: '/'},
        {value: 'speakers', name: 'Speakers', route: '/speakers'},
        {value: 'schedule', name: 'Schedule', route: '/schedule'},
        //{value: 'recap', name: 'Recap', route: '/recap'},
        {value: 'team', name: 'Team', route: '/team'}
      ],
      activeMenuItem: null,
      menuActive: false
    };
  ...
  render() {
    return (
      <nav className={'navigation' + (this.props.className? ' ' + this.props.className : '')}>
        <div className='content content-width'>

          <MenuIcon onClick={this.toggleMenuActive.bind(this)} className='menu-button' />

          <div className='left-container'>
            <h1 className='logo' onClick={this.onClickMenuItem.bind(this, '/')}><span>Huge Leap Week</span></h1>
          </div>
          ...
          <div className={'right-container' + (this.state.menuActive? ' active' : '')}>
            ...
            {/*
              <div className='social-media-items'>
                <a href='mailto:' target='_self'><MailIcon /></a>
                <a href='https://linkedin.com/in/' target='_blank'><LinkedinIcon /></a>
